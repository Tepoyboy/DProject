...
//             jumpCount++;
//             momentum += tr.up * jumpControlSpeed/2;
...
//                     gravity = Mathf.Lerp(gravity, 150, Time.deltaTime * fallAcceleration);
//                 } else {
//                     gravity = Mathf.Lerp(60, 150, Time.deltaTime * fallAcceleration * falling);
//                 }
